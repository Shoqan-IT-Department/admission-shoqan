            ...
            {admissions.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="relative mt-8 inline-flex items-center gap-2 self-start rounded-full border border-primary/20 px-5 py-2 text-sm font-medium text-primary transition group-hover:border-primary group-hover:bg-primary group-hover:text-primary-foreground">
                    {item.more}
