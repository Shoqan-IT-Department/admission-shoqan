          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 text-primary font-semibold ">
                ...
                >
                  {" "}
                  <li className="hover:underline">{t("school.agro")}</li>
                </Link>
                <Link
                  href={
                    "https://shokan.edu.kz/ru/schools/pedagogical-institute/"
                  }
                >
                  <li className="hover:underline"> {t("school.ped")}</li>
                </Link>
                <Link
                  href={
                    "https://shokan.edu.kz/ru/schools/vysshaya-shkola-mediciny/"
                  }
                >
                  <li className="hover:underline">{t("school.med")}</li>
                </Link>
                <Link
                  href={
                    "https://shokan.edu.kz/ru/schools/vysshaya-shkola-biznesa-i-prava/"
                  }
                >
                  {" "}
                  <li className="hover:underline">{t("school.business")}</li>
                </Link>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 text-primary font-semibold ">
                ...
                <Link href={"https://shokan.edu.kz/ru/graduate/"}>
                  <li className="hover:underline">
                    {t("incoming.magistracy")}
                  </li>
                </Link>
                <Link href={"https://shokan.edu.kz/ru/phd/"}>
                  <li className="hover:underline">{t("incoming.doctor")}</li>
                </Link>
              </ul>
            </div>
            {/* Дополнительно */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 font-semibold ">
            ...
            <div>
              ...
              <ul className="space-y-1 text-primary font-semibold ">
                ...
                >
                  <li className="hover:underline">{t("student.structure")}</li>
                </Link>
                <Link
                  href={
                    "https://shokan.edu.kz/ru/student-life/psychologist-blog/"
                  }
                >
                  <li className="hover:underline">{t("student.psychology")}</li>
                </Link>
                <Link
                  href={"https://shokan.edu.kz/ru/student-life/obshezhitiya/"}
                >
                  <li className="hover:underline">
                    {t("student.dormitories")}
                  </li>
                </Link>
              </ul>
            </div>
