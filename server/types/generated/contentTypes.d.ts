...
export interface ApiFooterQuestionFooterQuestion
  extends Struct.CollectionTypeSchema {
  collectionName: 'footer_questions';
  info: {
    displayName: 'FooterQuestion';
    pluralName: 'footer-questions';
    singularName: 'footer-question';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer-question.footer-question'
    >;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiHeadHead extends Struct.CollectionTypeSchema {
...
export interface ApiListDocumentListDocument
  extends Struct.CollectionTypeSchema {
  collectionName: 'list_documents';
  info: {
    displayName: 'List Docs';
    pluralName: 'list-documents';
    singularName: 'list-document';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::list-document.list-document'
    >;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiQuestionsStaticQuestionsStatic
  extends Struct.CollectionTypeSchema {
  collectionName: 'questions_statics';
  info: {
    displayName: 'Questions-static';
    pluralName: 'questions-statics';
    singularName: 'questions-static';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::questions-static.questions-static'
    >;
...
export interface ApiReseptionReseption extends Struct.CollectionTypeSchema {
  collectionName: 'reseptions';
  info: {
    displayName: 'Reseption';
    pluralName: 'reseptions';
    singularName: 'reseption';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    asked: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    consult: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::reseption.reseption'
    >;
    nationalExam: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    testingExam: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::footer-question.footer-question': ApiFooterQuestionFooterQuestion;
      ...
      'api::questions-static.questions-static': ApiQuestionsStaticQuestionsStatic;
      'api::reseption.reseption': ApiReseptionReseption;
